          ...
          <form onSubmit={handleSubmit} className="px-6 py-5 space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <input
                type="text"
                value={inGameName}
                onChange={(e) => { setInGameName(e.target.value); if (errors.inGameName) setErrors(p => ({ ...p, inGameName: undefined })); }}
            ...
            <div className="space-y-1.5">
              ...
              <input
                type="text"
                value={playerId}
                onChange={(e) => { setPlayerId(e.target.value); if (errors.playerId) setErrors(p => ({ ...p, playerId: undefined })); }}
