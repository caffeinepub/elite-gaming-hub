...
import { RegistrationData, PaymentData, RegistrationFlowStep } from '@/types/registration';
...
export default function MatchCard({ matchId, gameMode, entryFee, prizePool, status, animationDelay = 0 }: MatchCardProps) {
  ...
  const [flowStep, setFlowStep] = useState<RegistrationFlowStep>('idle');
