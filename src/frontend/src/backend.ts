...
export class Backend implements backendInterface {
    ...
    async deductEntryFee(arg0: bigint, arg1: bigint): Promise<{
        ok: boolean;
        newBalance: bigint;
        message: string;
    }> {
        if (this.processError) {
            try {
                const result = await this.actor.deductEntryFee(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitDepositRequest(arg0: bigint, arg1: string, arg2: string, arg3: string): Promise<{
        ok: boolean;
        requestId: bigint;
    }> {
        if (this.processError) {
...
function from_candid_DepositRequestStatus_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _DepositRequestStatus): DepositRequestStatus {
...
function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        screenshotNote: value.screenshotNote,
        status: from_candid_DepositRequestStatus_n13(_uploadFile, _downloadFile, value.status),
...
function from_candid_variant_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "pending" in value ? DepositRequestStatus.pending : "approved" in value ? DepositRequestStatus.approved : "rejected" in value ? DepositRequestStatus.rejected : value;
}
