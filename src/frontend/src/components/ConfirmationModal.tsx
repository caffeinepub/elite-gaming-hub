...
import { CheckCircle, Hash, Trophy, User, X } from "lucide-react";
      ...
      >
        ...
        >
          ...
          <div className="px-6 py-5 space-y-5">
            ...
            {/* Match Details */}
            <div
              className="bg-dark-bg rounded-md px-4 py-3 space-y-2"
            ...
            >
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="font-orbitron font-bold text-sm text-foreground">
                  Match #{matchId}
                </span>
              </div>
              <div className="flex items-center justify-between">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="font-orbitron font-bold text-sm text-neon-red-bright neon-text">
                  ₹{prizePool}
                </span>
              </div>
            </div>
            ...
            {registrationData && (
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-rajdhani text-sm text-muted-foreground uppercase tracking-wider w-24">
                    Name
                  </span>
