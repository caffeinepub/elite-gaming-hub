import { ChevronLeft, ChevronRight, Flame, Swords, Trophy } from "lucide-react";
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col justify-center px-6 sm:px-10 md:px-14">
              ...
              <div className="flex items-center gap-2 mb-2">
                <span
                  className={`${slide.tagColor} text-white text-xs font-orbitron font-bold px-2 py-0.5 rounded-sm tracking-widest pulse-neon`}
                >
                  {slide.tag}
                </span>
              ...
              {/* Title */}
              <h2 className="font-orbitron font-black text-2xl sm:text-3xl md:text-4xl lg:text-5xl uppercase tracking-widest text-foreground neon-text leading-none mb-1">
                {slide.title}
              </h2>
